...
int     infoWidth    = 500;
int     infoHeight   = 100;
int   addButtonColor,         removeButtonColor, 
...
public void setup() {
  ...
  definedNotes[0] = 261.63f;  definedNotes[1] = 277.18f;  definedNotes[2] = 293.66f;  definedNotes[3] = 311.13f; 
  definedNotes[4] = 329.63f;  definedNotes[5] = 349.23f;  definedNotes[6] = 369.99f;  definedNotes[7] = 392.00f; 
  definedNotes[8] = 415.30f;  definedNotes[9] = 440.00f;  definedNotes[10] = 466.16f; definedNotes[11] = 493.88f; 
  
  definedNotes[12] = 523.25f; definedNotes[13] = 554.37f; definedNotes[14] = 587.33f; definedNotes[15] = 622.25f; 
  definedNotes[16] = 659.26f; definedNotes[17] = 698.46f; definedNotes[18] = 739.99f; definedNotes[19] = 783.99f; 
  definedNotes[20] = 830.61f; definedNotes[21] = 880.00f; definedNotes[22] = 932.33f; definedNotes[23] = 987.77f;

  // Defining colours
  addButtonColor         = 0xffEAF0F8; addButtonHighlight     = 0xffD2DEEF; // Blue & Dark Blue
  removeButtonColor      = 0xffEAF0F8; removeButtonHighlight  = 0xffD2DEEF; // Blue & Dark Blue
  keyAndTempoButtonColor = 0xffEAF0F8; keyAndTempoHighlight   = 0xffD2DEEF; // Blue & Dark Blue
  synthButtonColor       = 0xffEAF0F8; synthButtonHighlight   = 0xffD2DEEF; // Blue & Dark Blue
  playButtonColor        = 0xffD0F0D3; playButtonHighlight    = 0xffA8ECAE; // Green & Dark Green
  stopButtonColor        = 0xffF6A4A4; stopButtonHighlight    = 0xffFE7676; // Red & Dark Red
  glyph = 0xff717171; // Grey
  ...
  // Note naming map
  frequencyToNoteMap.put(261.63f, "C" ); frequencyToNoteMap.put(277.18f, "C#");
  frequencyToNoteMap.put(293.66f, "D" ); frequencyToNoteMap.put(311.13f, "D#");
  frequencyToNoteMap.put(329.63f, "E" ); frequencyToNoteMap.put(349.23f, "F" );
  frequencyToNoteMap.put(369.99f, "F#"); frequencyToNoteMap.put(392.00f, "G" );
  frequencyToNoteMap.put(415.30f, "G#"); frequencyToNoteMap.put(440.00f, "A" );
  frequencyToNoteMap.put(466.16f, "A#"); frequencyToNoteMap.put(493.88f, "B" );

  frequencyToNoteMap.put(523.25f, "C" ); frequencyToNoteMap.put(554.37f, "C#");
  frequencyToNoteMap.put(587.33f, "D" ); frequencyToNoteMap.put(622.25f, "D#");
  frequencyToNoteMap.put(659.26f, "E" ); frequencyToNoteMap.put(698.46f, "F" );
  frequencyToNoteMap.put(739.99f, "F#"); frequencyToNoteMap.put(783.99f, "G" );
  frequencyToNoteMap.put(830.61f, "G#"); frequencyToNoteMap.put(880.00f, "A" );
  frequencyToNoteMap.put(932.33f, "A#"); frequencyToNoteMap.put(987.77f, "B" );  
...
\*                      */
// Following the mouse
public boolean hoveringOver(int x, int y, int width, int height) {
...
public void addNote() {
  ...
  if (notesInTimeline >= 16) {
    ...
    float  oscSusLvl  = 0.25f + randy.nextFloat() * (0.8f - 0.25f);
...
public Oscillator updateOscillator(Oscillator suppliedOsc) {
...
public void basicCircleButton(int buttonX, int buttonY, int background, String message, PImage imageName) {
...
public void circleHighlightButton(int buttonX, int buttonY, int background, int highlight, String message, PImage imageName) {
  // Rectangle parameter
  stroke(0);
  fill(background);
  rect(buttonX, buttonY, buttonWidth, buttonHeight);
...
public void basicSquare(int buttonX, int buttonY, int background, String message, PImage imageName) {
  // Rectangle parameters
  stroke(0);
  fill(background);
  rect(buttonX, buttonY, buttonWidth, buttonHeight);
...
public void squareHighlightButton(int buttonX, int buttonY, int background, int highlight, String message, PImage imageName) {
  // Rectangle parameter
  stroke(0);
  fill(background);
  rect(buttonX, buttonY, buttonWidth, buttonHeight);
